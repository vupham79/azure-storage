...
import * as azureBlob from "./azure-storage.blob.min";
...
// const blobService = azureBlob.createBlobServiceWithSas(blobUri, SAS);
function App() {
  //   const imageStyle = {
  ...
  //       file.size > 1024 * 1024 * 4 ? 1024 * 1024 * 4 : 1024 * 512;
  ...
  return (
    <Grid container justify="center" spacing={2} style={{ padding: "1rem" }}>
      <Typography variant={"h4"}>Azure Table Storage</Typography>
